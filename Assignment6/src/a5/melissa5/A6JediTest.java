...
public class A6JediTest {
	...
	/*
	 * Goal: Test if ZigZag Iterator Method traverses the pixels in zig-zag pattern from top left to bottom right
	 * Iterator should go up & to the right on even diagonals and down & to the left on odd diagonals
	 */
