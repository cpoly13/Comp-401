...
public class A6NoviceTest {
	...
	public void javaBeanTest(){
		...
		assertEquals("Pixel retrieved does not match expected",
				WHITE, PICTURE.getPixel(c));
	}
	@Test
	...
	public void basicIteratorTest(){
		...
		for(int a = 0; a < 2; ++a){
			for(int b = 0; b < 2; ++b){
				assertEquals("Pixel retrieved from iterator does not match expected pixel",
					i.next(), p.getPixel(b,a));
			}
		}
	}
}
