...
public class A6AdeptTest {
	...
	assertEquals("Sample does not work", p.getPixel(2, 3), sample1.next());
	...
	assertEquals("window does not work", source.getPixel(0, 0), p.getPixel(0, 0));
    }
	...
	assertEquals("tile does not work", source.getPixel(0, 0), p.getPixel(0, 0));
    }
}
