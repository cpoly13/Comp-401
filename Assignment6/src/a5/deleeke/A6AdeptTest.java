...
public class A6AdeptTest {
	...
	SubPicture[] expected = { pic.extract(0, 0, 3, 2), pic.extract(1, 0, 3, 2), pic.extract(2, 0, 3, 2),
		pic.extract(0, 1, 3, 2), pic.extract(1, 1, 3, 2), pic.extract(2, 1, 3, 2), pic.extract(0, 2, 3, 2),
		pic.extract(1, 2, 3, 2), pic.extract(2, 2, 3, 2), pic.extract(0, 3, 3, 2), pic.extract(1, 3, 3, 2),
		pic.extract(2, 3, 3, 2) };
	int i = 0;
