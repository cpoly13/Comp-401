...
public class A6NoviceTest {
	...
	public void testGetterAndSetter() {
		...
		assertEquals("Pixel retrieved from getPixel does not match expected",
				p.getPixel(1, 1), p.getPixel(c1));
		assertEquals("Pixel retrieved from getPixel does not match expected",
				p.getPixel(1, 2), p.getPixel(c2));
		assertEquals("Pixel retrieved from getPixel does not match expected",
				p.getPixel(0, 2), p.getPixel(c3));
		assertEquals("Pixel retrieved from getPixel does not match expected",
				p.getPixel(0, 0), p.getPixel(c4));
		...
		assertEquals("Pixel retrieved after setPixel does not match expected",
				p.getPixel(1, 1), p.getPixel(c1));
		assertEquals("Pixel retrieved after setPixel does not match expected",
				p.getPixel(1, 2), p.getPixel(c2));
		assertEquals("Pixel retrieved after setPixel does not match expected",
	...
	public void testOverloadedExtract() {
		...
		assertEquals("Pixel retrieved from subpicture does not match expected pixel value from source",
				p.getPixel(c1), sp2.getPixel(0,0));
		assertEquals("Pixel retrieved from subpicture does not match expected pixel value from source",
				p.getPixel(c2), sp2.getPixel(2,2));
		assertEquals("Pixel retrieved from subpicture does not match expected pixel value from source",
