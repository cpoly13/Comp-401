...
public class A6NoviceTest {
    ...
    // Testing whether the Coordinate constructor will both get and set a Pixel
    // at
    // a given coordinate.
    ...
    // Testing whether the extract method will correctly extract a subpicture
    // from
	...
	assertEquals("Expected pixel does not match output", picture.getPixel(2, 2), sub.getPixel(topLeft));
	assertEquals("Expected pixel does not match output", picture.getPixel(3, 2), sub.getPixel(2, 1));
    }
