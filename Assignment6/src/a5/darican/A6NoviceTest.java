...
public class A6NoviceTest {
	...
	public void coordinateTest() {
		...
		assertEquals("getPixel() called with coordinate different from getPixel()called with x and y" ,p.getPixel(1,0), p.getPixel(c1));
		try {
			p.getPixel(c2);
	...
	public void iteratorTest(){
		...
		assertTrue(p.getPixel(1, 1) == setPixel);
	}
