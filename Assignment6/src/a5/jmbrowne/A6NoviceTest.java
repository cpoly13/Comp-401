...
public class A6NoviceTest {
    ...
    @Test
    public void setPixelTest() // tests the implementation of the setPixel
			       // method in A6 Novice
    {
    ...
    @Test
    public void extractTest() // tests the implementation of the extract method
			      // in A6 Novice
    {
	PictureImpl testPic = new PictureImpl(10, 10);
	for (int i = 0; i < 10; i++) // assigns random gray pixels to the
