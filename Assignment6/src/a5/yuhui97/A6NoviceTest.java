...
public class A6NoviceTest {
	...
	public void testCoordGetPixel(){
		...
		assertEquals("Pixel mismatch for coordinate test",
				source.getPixel(coord1), source.getPixel(1, 1));
		assertEquals("Pixel mismatch for coordinate test",
				source.getPixel(coord2), source.getPixel(0, 1));
		assertEquals("Pixel mismatch for coordinate test",
				source.getPixel(coord3), source.getPixel(0, 0));
		assertEquals("Pixel mismatch for coordinate test",
				subpic.getPixel(subCoord1), source.getPixel(1, 1));
	...
	public void testCoordExtractSubpicture(){
		...
		assertEquals("Pixel mismatch for coordinate subicture test",
				source.getPixel(coord1), subpic.getPixel(subCoord2));
		assertEquals("Pixel mismatch for coordinate subicture test",
				source.getPixel(coord2), subpic.getPixel(subCoord1));	
	}
	...
	public void testPixelIterator(){
		...
		assertEquals("Wrong pixel by iterator",
				RED, sourceIterator.next());
		
		assertEquals("Wrong pixel by iterator",
				BLUE, sourceIterator.next());
		
		assertEquals("Wrong pixel by iterator",
				GREEN, sourceIterator.next());
		
		assertEquals("Wrong pixel by iterator",
				BLACK, sourceIterator.next());
	}
}
