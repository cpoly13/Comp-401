...
public class A6AdeptTest {
	...
	public void window() {
		...
		window_iter.next(); window_iter.next(); window_iter.next(); window_iter.next(); window_iter.next(); window_iter.next(); 
		window_iter.next(); window_iter.next(); window_iter.next(); window_iter.next(); window_iter.next();
