...
public class A6AdeptTest {
	...
	public void sampleTestValid(){
		...
		try {
			Iterator<Pixel> sample_iter1=p.sample(16,10,3,3);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<Pixel> sample_iter1=p.sample(-3,10,3,3);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<Pixel> sample_iter1=p.sample(13,-2,3,3);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<Pixel> sample_iter1=p.sample(13,12,3,3);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<Pixel> sample_iter1=p.sample(10,10,-3,3);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<Pixel> sample_iter1=p.sample(10,10,3,-3);
	...
	public void windowTestValid(){
		Picture p=new PictureImpl(15, 10);
		try {
			Iterator<SubPicture> window_iter1=p.window(-3,5);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<SubPicture> window_iter1=p.window(3,-5);
		...
		try {
			Iterator<SubPicture> window_iter1=p.window(16,5);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<SubPicture> window_iter1=p.window(3,11);
		} catch(IllegalArgumentException e){
		}
		}
	...
	public void tileTestValid(){
		Picture p=new PictureImpl(15, 10);
		try {
			Iterator<SubPicture> tile_iter=p.tile(-3,5);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<SubPicture> tile_iter=p.tile(3,-5);
		...
		try {
			Iterator<SubPicture> tile_iter=p.tile(19,5);
		} catch(IllegalArgumentException e){
		}
		try {
			Iterator<SubPicture> tile_iter=p.tile(3,14);
		} catch(IllegalArgumentException e){
		}
	}
