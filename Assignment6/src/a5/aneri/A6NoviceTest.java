...
public class A6NoviceTest {
	...
	assertEquals("Pixels retrieved from subpicture does not match expected pixel value from source", p.getPixel(c5),
		sp.getPixel(c1));
	assertEquals("Pixels retrieved from subpicture does not match expected pixel value from source", p.getPixel(c6),
		sp.getPixel(c2));
	assertEquals("Pixels retrieved from subpicture does not match expected pixel value from source", p.getPixel(c8),
		sp.getPixel(c4));
	assertEquals("Pixels retrieved from subpicture does not match expected pixel value from source", p.getPixel(c9),
		sp.getPixel(c5));
