...
public class A6NoviceTest {
	...
	assertEquals("Mr. T says you set the wrong pixel", testPixel, testPicture.getPixel(testCoordinate));
	...
	assertEquals(testSubPicture.getPixel(testCoordinate3), testExtractPicture.getPixel(testCoordinate3));
    }
}
