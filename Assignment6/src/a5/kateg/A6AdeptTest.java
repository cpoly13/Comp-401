...
public class A6AdeptTest {
	...
	// Can't do this because no next method for a subpicture: SubPicture z=
	// window_iter.next();
	...
	assertEquals("window iterator not working", window_iter.next().getPixel(0, 0),
		p.extract(0, 1, 3, 2).getPixel(0, 0));
	// calling getPixel() on each subpicture because can't compare that two
	// subpictures are equal
    }
