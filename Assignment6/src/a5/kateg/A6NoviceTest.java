...
public class A6NoviceTest {
	/*returns an array of strings that correspond 
	to each JUnit test in the class:	*/
	static public String[] getTestNames() {
		...
		//Calling next() after the last pixel has already been traversed should result in a java.util.NoSuchElementException.
//	@Test
...
//	}
	...
	@Test
	//checking to see if coordinate parameter gets same pixel value as x,y parameters
