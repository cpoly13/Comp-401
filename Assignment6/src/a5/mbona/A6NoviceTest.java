...
public class A6NoviceTest {
    ...
    /*
     * getPixelTest() should retrieve the pixel established in the PictureImpl
     * that I created.
     */
    ...
    /*
     * Tests if there is another pixel in the iterator. Goes through Picture's
     * pixels and outputs t/f if another follows.
     */
    ...
    /*
     * Uses iterator to find what the next pixel in the picture is. Returns t/f
     * if there is a next, equates what is next.
     */
    ...
    /*
     * Checks Coordinate parameters for out of bounds coordinates.
     */
