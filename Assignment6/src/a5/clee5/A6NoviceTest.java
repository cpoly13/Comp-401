...
public class A6NoviceTest {
	...
	public void testCoordinateGetters() {
		...
		assertEquals("Result from getX() does not match x coordinate",
				1, c.getX());
		assertEquals("Result from getY() does not match y coordinate",
				2, c.getY());
	}
	...
	public void testOverloadedPictureGettersAndSetters() {
		...
		assertEquals("Result from pic.getPixel(c) does not match ColorPixel",
				pix, pic.getPixel(c));
	}
