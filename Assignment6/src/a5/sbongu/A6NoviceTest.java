...
public class A6NoviceTest {
	...
	public void overloadSetPixelTest() {
		...
		assertTrue(picToSet.getPixel(2,4).equals(GREEN)); // test with Pixel method
	}
	...
	public void overloadGetPixelTest() {
		...
		assertTrue(picToSet.getPixel(corToSet).equals(RED)); //test with Pixel method
	}
	
	/* @Test
	public void overloadSubExtractTest() {
		Picture pic = new PictureImpl(10,10);
		SubPicture sub = pic.extract(1, 1, 2, 2);
		Coordinate cor1 = new Coordinate(1,1);
		Coordinate cor2 = new Coordinate(3,3);
