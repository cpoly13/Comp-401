...
public class A6AdeptTest {
	...
	assertTrue(it.next().getPixel(2, 1).getIntensity() == pic.extract(0, 0, 3, 2).getPixel(2, 1).getIntensity());
	assertTrue(it.next().getPixel(2, 1).getIntensity() == pic.extract(1, 0, 3, 2).getPixel(2, 1).getIntensity());
	assertTrue(it.next().getPixel(2, 1).getIntensity() == pic.extract(2, 0, 3, 2).getPixel(2, 1).getIntensity());
	it.next();
	assertEquals(it.next().getPixel(1, 1).getRed(), pic.extract(1, 1, 3, 2).getPixel(1, 1).getRed(), .0001);
    }
	...
	assertEquals(it.next().getPixel(2, 1).getIntensity(), pic.extract(0, 0, 2, 2).getPixel(2, 1).getIntensity(),
		.0001);
	assertEquals(it.next().getPixel(2, 1).getIntensity(), pic.extract(2, 0, 2, 2).getPixel(2, 1).getIntensity(),
		.0001);
	it.next();
	assertEquals(it.next().getPixel(1, 1).getRed(), pic.extract(2, 2, 2, 2).getPixel(1, 1).getRed(), .0001);
    }
}
