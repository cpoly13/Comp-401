...
public class A6NoviceTest {
	...
	public void setPixelTest() {
		...
		assertTrue(new ColorPixel(.3, .7, .8).getIntensity() ==
				pic.getPixel(4, 4).getIntensity());
	}
	...
	public void extractTest() {
		...
		assertTrue(sub.getPixel(3, 3).getIntensity() ==
				pic.extract(2, 2, 6, 6).getPixel(3, 3).getIntensity());
	}
