...
public class A6NoviceTest {
    ...
    /*
     * This method needs to return an array of strings that correspond to each
     * JUnit test in the class The autograder will be relying on this method to
     * test my tests
     */
    ...
    /*
     * @Test public void anyPictureExtractCoordinateTest() { Picture p = new
     * PictureImpl(3,3); Pixel BLACK = new ColorPixel(0,0,0); Pixel WHITE = new
     * ColorPixel(1,1,1); p.setPixel(0,0,BLACK); p.setPixel(0,1,WHITE);
     * p.setPixel(0,2,BLACK); p.setPixel(1,0,WHITE); p.setPixel(1,1,BLACK);
     * p.setPixel(1,2,WHITE); p.setPixel(2,0,BLACK); p.setPixel(2,1,WHITE);
     * p.setPixel(2,2,BLACK); Coordinate a = new Coordinate(1,1); Coordinate b =
     * new Coordinate(2,2);
     * 
    ...
    /*
     * @Test public void iteratorNextTest() { Picture p = new PictureImpl(2,2);
     * Pixel RED = new ColorPixel(1,0,0); Pixel BLUE = new ColorPixel(0,0,1);
     * p.setPixel(0,0,RED); p.setPixel(0,1,BLUE); p.setPixel(1,0,RED);
     * p.setPixel(1,1,BLUE); assertEquals(????,Iterator.next()); }
     */
}
