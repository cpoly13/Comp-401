...
public class A6AdeptTest {
	...
	/**
	 * try{ Iterator<Pixel> iterator = thisPic.sample(1, 1, 5, 10);
	 * fail("Should throw an exception"); }catch(IllegalArgumentException
	...
	try {
	    ...
	    aPic.window(5, 5);
	    fail("The parameters for the sub pic are larger " + "than the picture itself");
	} catch (IllegalArgumentException e) {
	} catch (RuntimeException e) {
	}
