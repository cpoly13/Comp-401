...
public class A6NoviceTest {
	...
	public void coordinateTester(){
		//The code commented out I think should not fail but it does so maybe KMP is wrong...?
		/**try{
			Coordinate newCoord = new Coordinate(-3,0);
			fail("Expected Illegal Argument Exception, no exception recieved");
		}catch(IllegalArgumentException e){
		}catch(RuntimeException e){
			fail("Expected Illegal Argument Exception, runtime exception recieved");
		}*/
		
		/**try{
			Coordinate newCoord = new Coordinate(5,-3);
			fail("Expected Illegal Argument Exception, no exception recieved");
		}catch(IllegalArgumentException e){
		}catch(RuntimeException e){
			fail("Expected Illegal Argument Exception, runtime exception was recieved");
		}*/
	...
	public void setPixelTester(){
		...
		try{
			...
			//fail("Expected illegal argument exception but recieved a runtime exception");
	...
	public void extractTester(){
		...
		SubPicture result = thisPic.extract(cornerA, cornerB);
	...
	public void rowMajorPixelIteratorTest(){
		AnyPicture pic = null;
		try{
			Iterator<Pixel> thisIterator = pic.iterator();
