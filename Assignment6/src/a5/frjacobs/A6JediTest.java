...
public class A6JediTest {
	...
	static public String[] getTestNames() {
		...
		test_names[9] = "testTileIteratorException";
		test_names[10] = "testCoordinateGenerator";
	...
	@Test(expected = IllegalArgumentException.class)
	public void testTileIteratorException(){
		TileIterator ti = new TileIterator(null, 10, 10);
	}
