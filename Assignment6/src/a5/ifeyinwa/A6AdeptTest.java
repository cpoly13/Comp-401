...
public class A6AdeptTest {
	...
	public void testSample() {
		...
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(2,3)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(5,3)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(8,3)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(11,3)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(14,3)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(2,7)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(5,7)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(8,7)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(11,7)), sample_iter.next());
		assertEquals("Pixel extracted from sample does not match expectation.", p.getPixel(new Coordinate(14,7)), sample_iter.next());
