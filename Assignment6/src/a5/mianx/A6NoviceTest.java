...
public class A6NoviceTest {
	...
	assertEquals("The overloaded setPixel method is incorrect", aPicture.getPixel(1, 1), aPicture.getPixel(1, 2));
	...
	assertEquals("The overloaded extract method is incorrect", subPic1.getHeight(), subPic2.getHeight());
	assertEquals("The overloaded extract method is incorrect", subPic1.getWidth(), subPic2.getWidth());
