...
public class A6AdeptTest {
	...
	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(2, 3)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(5, 3)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(8, 3)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(11, 3)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(14, 3)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(2, 7)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(5, 7)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(8, 7)), true);

	assertEquals("Sample itinerator returned wrong pixel", sample_iter.next().equals(p1.getPixel(11, 7)), true);
	...
	assertEquals("Sample Iterator hasNext broken", sample_iter2.hasNext(), false);
    }
	...
	assertEquals("Tile itinerator doesn't work right", isTheSamePicture(tile_iter.next(), p3.extract(0, 0, 2, 2)),
		true);

	assertEquals("Tile itinerator doesn't work right", isTheSamePicture(tile_iter.next(), p3.extract(2, 0, 2, 2)),
		true);

	assertEquals("Tile itinerator doesn't work right", isTheSamePicture(tile_iter.next(), p3.extract(0, 2, 2, 2)),
		true);

	assertEquals("Tile itinerator doesn't work right", isTheSamePicture(tile_iter.next(), p3.extract(2, 2, 2, 2)),
		true);
    }
