...
public class A6AdeptTest {
	...
	public void WindowExceptionsTests(){
		...
		try {
			Iterator<SubPicture> window_iter = pic.window(2, -2);
		...
		try {
			Iterator<SubPicture> window_iter = pic.window(2, 3);
	...
	public void TileExceptionsTests(){
		...
		try {
			Iterator<SubPicture> tile_iter = pic.tile(3, 2);
...
//		assertEquals("The sample iterator appears faulty", pic.sample(2,2,3,4), sample_iter);
//				
//				(pic.getPixel(2,3)),
