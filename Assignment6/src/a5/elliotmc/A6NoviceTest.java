...
public class A6NoviceTest {
	...
	assertEquals("Pixel retrieved does not match expected pixel", p.getPixel(1, 1), sp.getPixel(0, 0));
	assertEquals("Pixel retrieved does not match expected pixel", p.getPixel(2, 1), sp.getPixel(1, 0));
	assertEquals("Pixel retrieved does not match expected pixel", p.getPixel(1, 2), sp.getPixel(0, 1));
	assertEquals("Pixel retrieved does not match expected pixel", p.getPixel(2, 2), sp.getPixel(1, 1));
