...
public class A6AdeptTest {
	...
	assertEquals("iterator didn't do the right thing", p.getPixel(1, 1), weirdo.next());
	assertEquals("iterator didn't do the right thing", p.getPixel(3, 1), weirdo.next());
	assertEquals("iterator didn't do the right thing", p.getPixel(1, 3), weirdo.next());
	assertEquals("iterator didn't do the right thing", p.getPixel(3, 3), weirdo.next());
	...
	// p.extract(0, 0, 3, 2).compareSubPictures(),
	// weirdo.next().compareSubPictures());
	...
	return (a.getXOffset() == b.getXOffset() && a.getYOffset() == b.getYOffset() && a.getWidth() == b.getWidth()
