...
public class A6NoviceTest {
	...
	public void testGetSetPixelCoord() {
		...
		assertEquals("Pixel retreived using coordinate does not match pixel from source",
				RED, PICTURE.getPixel(c));		
	}
	...
	public void testIterator() {
		...
		assertEquals("Pixel from iterator does not match expected pixel value",
				RED, i.next());
	...
	public void testSubpictureExtractbyCoord() {
		...
		assertEquals("Extract pixel values do not match expected pixel values",
				RED, spCoord.getPixel(0, 0));
		assertEquals("Extract pixel values do not match expected pixel values",
				BLUE, spCoord.getPixel(1, 0));
		assertEquals("Extract pixel values do not match expected pixel values",
				GREEN, spCoord.getPixel(0, 1));
		assertEquals("Extract pixel values do not match expected pixel values",
				BLUE, spCoord.getPixel(1, 1));
	}
