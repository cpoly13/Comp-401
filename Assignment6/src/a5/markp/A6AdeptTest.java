...
public class A6AdeptTest {
	...
	public void testSample() {
		...
		Iterator<Pixel> sampleIter = p.sample(0, 0, 1, 1); // normal iterator pattern test
		...
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(2, 2));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(5, 2));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(8, 2));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(2, 5));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(5, 5));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(8, 5));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(2, 8));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(5, 8));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter1.next(), picTest1.getPixel(8, 8));
		...
		assertEquals("Values from iterator do not match expected values", 
				sampleIter2.next(), picTest2.getPixel(1, 2));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter2.next(), picTest2.getPixel(2, 2));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter2.next(), picTest2.getPixel(1, 5));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter2.next(), picTest2.getPixel(2, 5));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter2.next(), picTest2.getPixel(1, 8));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter2.next(), picTest2.getPixel(2, 8));
		...
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(2, 20));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(12, 20));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(22, 20));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(2, 22));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(12, 22));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(22, 22));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(2, 24));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(12, 24));
		assertEquals("Values from iterator do not match expected values", 
				sampleIter3.next(), picTest3.getPixel(22, 24));
