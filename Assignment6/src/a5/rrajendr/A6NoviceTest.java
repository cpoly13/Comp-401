...
public class A6NoviceTest {
	...
	Assert.assertEquals(
		(String) "Pixel returned from Subpicture not same value as corresponding pixel from Source.",
	...
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) RED,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) RED,
		noviceIterator.next());
	...
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) RED,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) GREEN,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) BLUE,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) GREEN,
		noviceIterator.next());
	...
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) BLUE,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) BLACK,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) BLACK,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) WHITE,
		noviceIterator.next());
	Assert.assertTrue((boolean) noviceIterator.hasNext());
	Assert.assertEquals((String) "Next pixel retrieved by iterator is not expected pixel", (Object) WHITE,
		noviceIterator.next());
