...
public class A6AdeptTest {
	...
	//Tests that the offset pixels are correct when retrieved from the Iterator.
	...
	public void testWindow() {
		...
		assertEquals("The Pixel returned is not correct",
				picture4.getPixel(p1), windowPic.getPixel(sp1));
		assertEquals("The Pixel returned is not correct",
				picture4.getPixel(p2), windowPic.getPixel(sp2));
		assertEquals("The Pixel returned is not correct",
				picture4.getPixel(p3), windowPic.getPixel(sp3));
		assertEquals("The Pixel returned is not correct",
				picture4.getPixel(p4), windowPic.getPixel(sp4));
