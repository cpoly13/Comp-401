...
public class A6AdeptTest {
	...
	assertEquals("The iterator's pixel does not match with the intended value", BLACK, sampleIterator.next());
	assertEquals("The iterator's pixel does not match with the intended value", BLACK, sampleIterator.next());
	assertEquals("The iterator's pixel does not match with the intended value", BLACK, sampleIterator.next());
	assertEquals("The iterator's pixel does not match with the intended value", BLACK, sampleIterator.next());
	assertEquals("The iterator's pixel does not match with the intended value", BLACK, sampleIterator.next());
	...
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(0, 0, 2, 2).getPixel(0, 0),
		tile1.getPixel(0, 0));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(0, 0, 2, 2).getPixel(1, 1),
		tile1.getPixel(1, 1));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(0, 0, 2, 2).getPixel(2, 2),
		tile1.getPixel(2, 2));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(2, 0, 2, 2).getPixel(0, 0),
		tile2.getPixel(0, 0));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(2, 0, 2, 2).getPixel(1, 1),
		tile2.getPixel(1, 1));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(2, 0, 2, 2).getPixel(2, 2),
		tile2.getPixel(2, 2));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(0, 2, 2, 2).getPixel(0, 0),
		tile3.getPixel(0, 0));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(0, 2, 2, 2).getPixel(1, 1),
		tile3.getPixel(1, 1));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(0, 2, 2, 2).getPixel(2, 2),
		tile3.getPixel(2, 2));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(2, 2, 2, 2).getPixel(0, 0),
		tile4.getPixel(0, 0));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(2, 2, 2, 2).getPixel(1, 1),
		tile4.getPixel(1, 1));
	assertEquals("The pixel in the tile doesn't match the source", tileSource.extract(2, 2, 2, 2).getPixel(2, 2),
		tile4.getPixel(2, 2));
    }
}
