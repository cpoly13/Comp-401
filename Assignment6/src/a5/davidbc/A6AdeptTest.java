...
/*	
	...
	public void windowTest(){
		Picture testPict = new PictureImpl(5,5);
		//Pixel testPixel = new GrayPixel(0.2);
		//testPict.setPixel(1, 1,testPixel);
		//testPict.setPixel(2, 3,testPixel);
		//testPict.setPixel(3, 1,testPixel);
		//testPict.setPixel(0,3,testPixel);
		Iterator<SubPicture> testWindow = testPict.window(3, 2);
		assertEquals(testWindow.next(), testPict.extract(0,0,3,2));
