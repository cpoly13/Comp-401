...
public class A6AdeptTest {
	...
	assertTrue(tiler.next().getPixel(1, 1).getIntensity() == p.extract(0, 0, 2, 2).getPixel(1, 1).getIntensity());
	assertTrue(tiler.next().getPixel(1, 1).getIntensity() == p.extract(2, 0, 2, 2).getPixel(1, 1).getIntensity());
	assertTrue(tiler.next().getPixel(1, 1).getIntensity() == p.extract(0, 2, 2, 2).getPixel(1, 1).getIntensity());
	assertTrue(tiler.next().getPixel(1, 1).getIntensity() == p.extract(2, 2, 2, 2).getPixel(1, 1).getIntensity());
