...
public class A6JediTest {
	...
	int[][] coordXY = { { 0, 0 }, { 1, 0 }, { 0, 1 }, { 0, 2 }, { 1, 1 }, { 2, 0 }, { 2, 1 }, { 1, 2 }, { 0, 3 },
		{ 0, 4 }, { 1, 3 }, { 2, 2 }, { 2, 3 }, { 1, 4 }, { 0, 5 }, { 1, 5 }, { 2, 4 }, { 2, 5 } };
	// both arrays are length 18 (hopefully)
	Pixel[] color = { BLACK, BLACK, BLACK, WHITE, RED, BLUE, BLUE, WHITE, RED, GREEN, BLACK, WHITE, WHITE, BLUE,
