...
public class A6JediTest {
	...
	for (int x = 0; x < 9; x++) {
	    assertEquals("zigzag test 1", pic.next(), pic2.next());
	    assertEquals("zigzag test 2", pic.hasNext(), pic2.hasNext());
	}

	// check out of bounds boolean
	assertEquals("Out of Bounds check 1", pic.hasNext(), pic2.hasNext());
	assertEquals("Out of Bounds check 2", pic.hasNext(), pic2.hasNext());
