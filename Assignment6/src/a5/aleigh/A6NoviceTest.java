...
public class A6NoviceTest {
	...
	assertEquals("Pixel returned does not match expected SubPicture value", testPicture.getPixel(1, 1),
		testSP.getPixel(0, 0));
	assertEquals("Pixel returned does not match expected SubPicture value", testPicture.getPixel(1, 2),
		testSP.getPixel(0, 1));
	assertEquals("Pixel returned does not match expected SubPicture value", testPicture.getPixel(1, 3),
		testSP.getPixel(0, 2));
