...
public class A6NoviceTest {
	...
	assertEquals("Pixel does not match source", pic.getPixel(c1), pix00);
	assertEquals("Pixel does not match source", pic.getPixel(c2), pix10);
	assertEquals("Pixel does not match source", pic.getPixel(c3), pix20);
	assertEquals("Pixel does not match source", pic.getPixel(c4), pix01);
	assertEquals("Pixel does not match source", pic.getPixel(c5), pix11);
	assertEquals("Pixel does not match source", pic.getPixel(c6), pix21);
	assertEquals("Pixel does not match source", pic.getPixel(c7), pix02);
	assertEquals("Pixel does not match source", pic.getPixel(c8), pix12);
	assertEquals("Pixel does not match source", pic.getPixel(c9), pix22);
    }
