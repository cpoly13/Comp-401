...
public class A6NoviceTest {
	...
	@Test   //Tests that the pixel iterator returns the correct objects and that the final next() call returns the proper exception
    ...
    public void setPixelCoordinate() {
        ...
        assertEquals("Overloaded setPixel using coordinate does not match xy version",coordinateTestPic.getPixel(1,0),xyTestPic.getPixel(1,0));

    }

    @Test   //Tests that the getCoordinate version of getPixel functions the same as x y
    public void getPixelCoordinate() {
        ...
        assertEquals("Overloaded getPixel using coordinate does not match xy version",testPic.getPixel(0,0),testPic.getPixel(zeroZero));

    }

    @Test   //Tests that the getCoordinate version of extract functions the same as x y
    public void extractCoordinate() {
        ...
        assertEquals("Overloaded extract SubPicture using coordinate does not match xy version",true,comparePictures(xyExtract,coordinateExtract));
