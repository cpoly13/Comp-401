...
public class A6NoviceTest {
    ...
    static public String[] getTestNames() // Retrieves all test names for
					  // A6Novice.
    {
    ...
    @Test
    public void testOverloadedSetPixel() // Tests the overloaded method for
					 // setPixel using a coordinate object.
    {
	...
	assertEquals("The intensity of the pixel at (6, 4) does not match the intensity of the set pixel.", 1,
		p.getPixel(c).getIntensity(), 0.01);
    }

    @Test
    public void testOverloadedExtract() // Tests the overloaded method for
					// extract using a coordinate object.
    {
    ...
    @Test
    public void testOverloadedSetPixelNullError() // Tests the overloaded method
						  // for setPixel to confirm
    ...
    @Test
    public void testOverloadedSetPixelBoundsError() // Tests the overloaded
						    // method for setPixel to
						    // confirm
    ...
    @Test
    public void testOverloadedGetPixelBoundsError() // Tests the overloaded
						    // method for getPixel to
						    // confirm
    { // that it gives a error for out of bounds coordinates.
	Picture p = new PictureImpl(10, 10);
	Coordinate c = new Coordinate(12, 14);
