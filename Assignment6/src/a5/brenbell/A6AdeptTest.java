...
public class A6AdeptTest {
	...
	assertTrue(testPicIterator.hasNext());
	assertEquals("The pixel given to the iterator isn't what is expected.", GREEN, testPicIterator.next());
	assertEquals("The pixel given to the iterator isn't what is expected.", RED, testPicIterator.next());
	...
	assertEquals("The next pixel given by the window iterator was not expected.", testPic.getPixel(testA),
		subPicTest.getPixel(windowTestA));
	assertEquals("The next pixel given by the window iterator was not expected.", testPic.getPixel(testB),
		subPicTest.getPixel(windowTestB));
	assertEquals("The next pixel given by the window iterator was not expected.", testPic.getPixel(testC),
		subPicTest.getPixel(windowTestC));
