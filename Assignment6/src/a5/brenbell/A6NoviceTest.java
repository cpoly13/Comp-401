...
public class A6NoviceTest {
	...
	public void testIterator() {
		...
		Assert.assertEquals("The next pixel isn't what I expected.", 
		GREEN, testPicIterator.next());
		
		Assert.assertTrue(testPicIterator.hasNext());
		Assert.assertEquals("The next pixel isn't what I expected.", 
		BLUE, testPicIterator.next());
		
		Assert.assertTrue(testPicIterator.hasNext());
		Assert.assertEquals("The next pixel isn't what I expected.", 
		RED, testPicIterator.next());
		...
		Assert.assertTrue(testPicIterator.hasNext());
		Assert.assertEquals("The next pixel isn't what I expected.", 
		BLACK, testPicIterator.next());
		
		Assert.assertTrue(testPicIterator.hasNext());
		Assert.assertEquals("The next pixel isn't what I expected.", 
		WHITE, testPicIterator.next());
	...
	public void testCoordinates() {
		...
		Assert.assertEquals("The pixel made by coordinates does not match the picture given.", testPic.getPixel(testA), testPic.getPixel(0,0));
		Assert.assertEquals("The pixel made by coordinates does not match the picture given.", testPic.getPixel(testB), testPic.getPixel(0,1));
		Assert.assertEquals("The pixel made by coordinates does not match the picture given.", testPic.getPixel(testC), testPic.getPixel(1,0));
	...
	public void testExtract() {
		...
		Assert.assertEquals("The pixel extracted doesn't match what the source is.", testPic.getPixel(testA), subTestPic.getPixel(subTestA));
		Assert.assertEquals("The pixel extracted doesn't match what the source is.", testPic.getPixel(testB), subTestPic.getPixel(subTestB));
		Assert.assertEquals("The pixel extracted doesn't match what the source is.", testPic.getPixel(testC), subTestPic.getPixel(subTestC));
