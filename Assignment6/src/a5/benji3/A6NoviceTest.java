...
public class A6NoviceTest {
	...
	assertEquals("Result from getPixel(Coordinate c) does not match source picture", WHITE, a.getPixel(c));
    }
	...
	assertEquals("Result from setPixel(Coordinate c) does not match source picture", WHITE, a.getPixel(c));

    }

    // Testing extract method that uses two coordinates to find its width,
    // height, and offsets.
