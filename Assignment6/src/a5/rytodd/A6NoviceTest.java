...
public class A6NoviceTest {
	...
	public void testExtract(){
		...
		assertEquals("Pixel mismatch",
				p.extract(d, i).getPixel(a), newp1.getPixel(a));
		assertEquals("Pixel mismatch",
				p.extract(d, i).getPixel(f), newp1.getPixel(f));
		assertEquals("Pixel mismatch",
				p.extract(d, i).getPixel(c), newp1.getPixel(c));
