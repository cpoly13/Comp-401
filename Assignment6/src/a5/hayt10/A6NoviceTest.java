...
public class A6NoviceTest {
    ...
    @Test
    /**
     * Ensures pixels are set and retrieved properly by using coordinates for
     * the overloaded getPixel and setPixel methods
     */
    ...
    @Test
    /**
     * Test the iterator to ensure the hasNext method and next methods function
     * properly
     */
	...
	// Check the number of iterations and see if every element is visited
	// exactly once
	assertEquals("Iterator doesn't iterate the correct number of times,", iterations,
