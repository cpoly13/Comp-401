...
public class A6NoviceTest {
	...
	//Test checks that it is true that there is a next element to iterate through
	@Test
	...
	public void coordinateGetterTest(){ //test method declaration
		...
		//tests if expected value matches with value resulting from .getX() and .getY()
	...
	public void extractTest(){ // test method declaration 
		...
		Coordinate corner_a = new Coordinate(3,2); //create a new coordinate object
		Coordinate corner_b = new Coordinate(7,5); //create a new coordinate object
		...
		//checks if expected coordinate value matches value resulting from calling
