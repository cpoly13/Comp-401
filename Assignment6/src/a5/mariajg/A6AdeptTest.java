...
public class A6AdeptTest {
	...
	// creates new sub picture object by calling extract method and
	// retrieving
	...
	Iterator<SubPicture> window_iter = p.window(3, 2); // creates iterator
							   // object to slide
							   // (3,2)
	...
	Iterator<SubPicture> tile_iter = p.tile(2, 2);// creates tile iterator
						      // to shift (2,2)
