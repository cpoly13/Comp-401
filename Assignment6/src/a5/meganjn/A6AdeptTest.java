...
public class A6AdeptTest {
  ...
  public void windowTest() {
    ...
    assertTrue("window not working",
        comparePictures(windowIterator.next(), p.extract(0, 0, 3, 3)));
    assertTrue("window not working",
        comparePictures(windowIterator.next(), p.extract(1, 0, 3, 3)));
    assertTrue("window not working",
        comparePictures(windowIterator.next(), p.extract(0, 1, 3, 3)));
    assertTrue("window not working",
        comparePictures(windowIterator.next(), p.extract(1, 1, 3, 3)));
  }
  ...
  public void tileTest() {
    ...
    assertTrue("tile not working",
        comparePictures(tileIterator.next(), p.extract(0, 0, 2, 2)));
    assertTrue("tile not working",
        comparePictures(tileIterator.next(), p.extract(2, 0, 2, 2)));
    assertTrue("tile not working",
        comparePictures(tileIterator.next(), p.extract(0, 2, 2, 2)));
    assertTrue("tile not working",
        comparePictures(tileIterator.next(), p.extract(2, 2, 2, 2)));
