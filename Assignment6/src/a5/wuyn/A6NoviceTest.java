...
public class A6NoviceTest {
	...
	public void testExtactBadParameters(){
		...
		try {
			SubPicture sp = p.extract(c1, new Coordinate(1,1));
		...
		try {
			SubPicture sp = p.extract(new Coordinate(1,1), c2);
			fail("Expected IllegalArgumentException for coordinates out of bound");
		} catch (IllegalArgumentException e) {
		} catch (RuntimeException e) {
		}
		...
		try {
			SubPicture sp = p.extract(c3, new Coordinate(1,1));
			fail("Expected IllegalArgumentException for coordinates out of bound");
		} catch (IllegalArgumentException e) {
		} catch (RuntimeException e) {
		}
		...
		try {
			SubPicture sp = p.extract(new Coordinate(1,1), c4);
			fail("Expected IllegalArgumentException for coordinates out of bound");
		} catch (IllegalArgumentException e) {
		} catch (RuntimeException e) {
		}
	...
	public void testIteratorBasics(){
		...
		assertEquals("Pixel from the Interator<Pixel> does not match Pixel from source in order",
				p.getPixel(c_00), p00);
		assertEquals("Pixel from the Interator<Pixel> does not match Pixel from source in order",
				p.getPixel(c_10), p10);
		assertEquals("Pixel from the Interator<Pixel> does not match Pixel from source in order",
	...
	public void testIteratorExceptions(){
		...
		try{
			...
			Pixel p_00 = iter1.next();
			Pixel p_10 = iter1.next();
			Pixel p_20 = iter1.next();
			Pixel p_01 = iter1.next();
			Pixel p_11 = iter1.next();
			Pixel p_21 = iter1.next();
			Pixel p_02 = iter1.next();
			Pixel p_12 = iter1.next();
			Pixel p_22 = iter1.next();
			Pixel p_exception = iter1.next();
