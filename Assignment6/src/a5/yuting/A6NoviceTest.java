...
public class A6NoviceTest {
	...
	public void CoordinateTest_Setters() {
		...
		assertEquals("Pixel set from Coordinate is different from the expected value ",
				BLACK,source2.getPixel(cordinate4));
		assertEquals("Pixel set from Coordinate is different from the expected value ",
				RED,source2.getPixel(cordinate5));
		assertEquals("Pixel set from Coordinate is different from the expected value ",
				BLUE,source2.getPixel(cordinate6));
	...
	//Test First Pixel
		assertTrue("The iterator cannot find the Pixel(0,0) ",
				iter.hasNext());
		assertEquals("Pixel gott from iterator is different from the expected value ",
				WHITE,source1.getPixel(0,0));
		
		//Test Second Pixel
		assertTrue("The iterator cannot find the Pixel(1,0) ",
				iter.hasNext());
		assertEquals("Pixel gott from iterator is different from the expected value ",
				BLACK,source1.getPixel(1,0));
		
		//Test Third Pixel
		assertTrue("The iterator cannot find the Pixel(2,0) ",
				iter.hasNext());
		assertEquals("Pixel gott from iterator is different from the expected value ",
				RED,source1.getPixel(2,0));
		
		//Test Fourth Pixel
		assertTrue("The iterator cannot find the Pixel(0,1) ",
				iter.hasNext());
		assertEquals("Pixel gott from iterator is different from the expected value ",
				GREEN,source1.getPixel(0,1));
		
		//Test Fifth Pixel
		assertTrue("The iterator cannot find the Pixel(1,1) ",
				iter.hasNext());
		assertEquals("Pixel gott from iterator is different from the expected value ",
				BLUE,source1.getPixel(1,1));
		
		//Test Sixth Pixel
		assertTrue("The iterator cannot find the Pixel(2,1) ",
				iter.hasNext());
		assertEquals("Pixel gott from iterator is different from the expected value ",
				WHITE,source1.getPixel(2,1));
	...
	public void ExtractByCoordinatesTest() {
		...
		//To test if the first row of the subPicture1 matches the second row of the source4
