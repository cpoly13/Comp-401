...
public class A6AdeptTest {
	...
	public void sampleTest() {
		...
		assertEquals("Pixel 1 is not as expected", 
				expected1, iter1.next());
		assertEquals("Pixel 2 is not as expected", 
				expected2, iter1.next());
		assertEquals("Pixel 3 is not as expected", 
				expected3, iter1.next());
		assertEquals("Pixel 4 is not as expected", 
				expected4, iter1.next());
		assertEquals("Pixel 5 is not as expected", 
				expected5, iter1.next());
		assertEquals("Pixel 6 is not as expected", 
				expected6, iter1.next());
		assertEquals("Pixel 7 is not as expected", 
				expected7, iter1.next());
		assertEquals("Pixel 8 is not as expected", 
				expected8, iter1.next());
		assertEquals("Pixel 9 is not as expected", 
				expected9, iter1.next());
	...
	public void windowTest() {
		...
		for(int x = 0; x < expected1.getWidth(); x++) {
			for(int y = 0; y < expected1.getHeight(); y++) {
				assertEquals("SubPicture 1 not as expected",
						expected1.getPixel(x, y), iterTemp.getPixel(x, y));
			}
		}
		...
		for(int x = 0; x < expected2.getWidth(); x++) {
			for(int y = 0; y < expected2.getHeight(); y++) {
				assertEquals("SubPicture 2 not as expected",
						expected2.getPixel(x, y), iterTemp.getPixel(x, y));
			}
		}
		...
		for(int x = 0; x < expected3.getWidth(); x++) {
			for(int y = 0; y < expected3.getHeight(); y++) {
				assertEquals("SubPicture 1 not as expected",
						expected3.getPixel(x, y), iterTemp.getPixel(x, y));
			}
		}
		...
		for(int x = 0; x < expected4.getWidth(); x++) {
			for(int y = 0; y < expected4.getHeight(); y++) {
				assertEquals("SubPicture 1 not as expected",
						expected4.getPixel(x, y), iterTemp.getPixel(x, y));
			}
		}
