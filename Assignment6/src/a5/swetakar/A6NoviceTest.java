...
public class A6NoviceTest {
	...
	public void testSetPixel() {
		...
		p.setPixel(c, GREEN);
		assertEquals("Pixel not set correctly in picture",
				p.getPixel(2, 2), GREEN);
	}
	@Test
	public void testGetPixel() {
		...
		p.setPixel(c, GREEN);
		assertEquals("Pixel not retrieved correctly in picture",
				p.getPixel(c), GREEN);
	}
	@Test
	public void testExtract() {
		...
		assertEquals("Extract function not implemented correctly with coordinate arguments. - x offset", sub1.getXOffset(), sub2.getXOffset());
		assertEquals("Extract function not implemented correctly with coordinate arguments. - y offset", sub1.getYOffset(), sub2.getYOffset());
		assertEquals("Extract function not implemented correctly with coordinate arguments. - source", sub1.getSource(), sub2.getSource());
		assertEquals("Extract function not implemented correctly with coordinate arguments. - width", sub1.getWidth(), sub2.getWidth());
		assertEquals("Extract function not implemented correctly with coordinate arguments. - height", sub1.getHeight(), sub2.getHeight());
	...
	public void testIterator() {
		...
		assertEquals("Iterator implementation is not correct", iter.hasNext(), true); //filled with gray pixels
		p.setPixel(0, 0, RED);
		p.setPixel(1, 0, RED);
		p.setPixel(2, 0, RED);
		p.setPixel(0, 1, GREEN);
