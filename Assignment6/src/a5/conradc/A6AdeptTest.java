...
public class A6AdeptTest {
    ...
    /**
     * JUnit test for sample iterator of PictureImpl Input: None Output: Asserts
     * whether sample iterator was properly implemented
     */
    ...
    /**
     * JUnit test for window iterator of PictureImpl Input: None Output: Asserts
     * whether window iterator was properly implemented
     */
    ...
    /**
     * JUnit test for tile iterator of PictureImpl Input: None Output: Asserts
     * whether tile iterator was properly implemented
     */
     ...
     * Input: None Output: PictureImpl object filled with unique Pixels
     */
