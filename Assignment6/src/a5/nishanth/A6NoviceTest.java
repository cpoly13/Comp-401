...
public class A6NoviceTest {
	...
	public void getSetPixelTest(){
		...
		//The above doesn't work because they have different locations in memory.
	...
	public void extractTest(){
		...
		//width should be three, because I start at (1,1), and going to the right,
		//you have pixels at (1,1), (1,2), (1,3), so the width is three. You count
	...
	public void iteratorTest(){
		...
		pic.setPixel(c2,black);
		pic.setPixel(c18,white);
		Pixel[][] pixels = new Pixel [4][6]; //initializing array of pixels
		Iterator<Pixel> iterator = pic.iterator();
		/*for (int i = 0; i < 4; i++){
			for(int j = 0; j < 7; j++){
				
				pixels[i][j] = pic.setPixel();
