...
public class A6AdeptTest {
	...
	public void windowTest(){
		...
		SubPicture expected[] = {pic.extract(0, 0, 4, 5),
				pic.extract(1, 0, 4, 5), pic.extract(2, 0, 4, 5),
				pic.extract(3, 0, 4, 5), pic.extract(4, 0, 4, 5),
				pic.extract(5, 0, 4, 5), pic.extract(6, 0, 4, 5)};
