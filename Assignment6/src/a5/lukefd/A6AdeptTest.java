...
public class A6AdeptTest {
	...
	public void windowTest() {
		...
		assertEquals("Tile height returned by iterator does not match expected value.", p.extract(0,0,3,2).getHeight(), 
				t.getHeight());
		assertEquals("Tile width returned by iterator does not match expected value.", p.extract(0,0,3,2).getWidth(), 
				t.getWidth());
		assertEquals("Tile xOffSet returned by iterator does not match expected value.", p.extract(0,0,3,2).getXOffset(), 
				t.getXOffset());
		assertEquals("Tile yOffSet returned by iterator does not match expected value.", p.extract(0,0,3,2).getYOffset(), 
				t.getYOffset());
	}
	...
	public void tileTest() {
		...
		assertEquals("Tile height returned by iterator does not match expected value.", p.extract(0,0,2,2).getHeight(), 
				t.getHeight());
		assertEquals("Tile width returned by iterator does not match expected value.", p.extract(0,0,2,2).getWidth(), 
				t.getWidth());
		assertEquals("Tile xOffSet returned by iterator does not match expected value.", p.extract(0,0,2,2).getXOffset(), 
				t.getXOffset());
		assertEquals("Tile yOffSet returned by iterator does not match expected value.", p.extract(0,0,2,2).getYOffset(), 
				t.getYOffset());
	}
}
