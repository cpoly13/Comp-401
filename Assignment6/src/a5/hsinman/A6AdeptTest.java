...
public class A6AdeptTest {
    ...
    /*
     * A method to get test names as strings for A6 Adept. test_names is an
    ...
    /*
     * Test for sample() method in A6 Adept. Creates arbitrary Pixels tied to
     * certain Coordinates in a picture that correspond to the correct values of
     * sample_interator Compares the Pixel to the place in the iterator where it
     * should be.
     */
    @Test
