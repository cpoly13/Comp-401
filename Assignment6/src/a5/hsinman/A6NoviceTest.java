...
public class A6NoviceTest {
    ...
    /*
     * A method to get test names as strings for A6 Novice. test_names is an
     * array of the names of the tests.
     */
    ...
    /*
     * Test for getPixel() method in A6 Novice. Compares an arbitrary Pixel that
     * was assigned to Picture p with the output from p.getPixel() that should
    ...
    /*
     * Test for extract() method in A6 Novice. Compares the height, width, and
     * Pixel when the get methods are directly called on the subpicture and when
     * the extract method is used to get the subpicture.
     */
    @Test
    ...
    /*
     * Test for setPixel() method in A6 Novice. Creates 3 arbitrary Pixels with
     * coordinating Coordinates in an arbitrary Picture and then sets them to
     * their correct location. The test compares the output from getPixel() in
     * the coordinate location and the original Pixel that was created.
     */
    @Test
